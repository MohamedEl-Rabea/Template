using Autofac;
using Autofac.Core;
using CompanyName.ProjectName.BuildingBlocks.Infrastructure.Serialization;
using CompanyName.ProjectName.BuilidingBlocks.Application.Events;
using CompanyName.ProjectName.BuilidingBlocks.Application.Outbox;
        ...
        public async Task DispatchEventsAsync()
        {
            ...
            foreach (var domainEventNotification in domainEventNotifications)
            {
                ...
                var outboxMessage = new OutboxMessage(
                    ...
                    domainEventNotification.DomainEvent.EventTime,
                    type,
                    data);
